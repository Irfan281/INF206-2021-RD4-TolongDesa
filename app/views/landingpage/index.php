    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-3">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          ...
          <a class="navbar-brand fw-bolder fs-2 mx-auto" href="#">Tolong<span class="fw-normal">Desa</span> </a>
          <div class="d-flex">
            <a class="btn shadow-sm border-3 py-1 px-4 fw-bold text-white btn-orange" href="login.php">Login</a>
          </div>
        </div>
      </div>
    </nav>
      ...
      <div class="row">
        <div class="col-12 col-lg-6 mt-lg-0 mt-5 ms-4">
          <div class="hero-text">
            ...
            <a href="daftar.php" class="btn shadow-sm border-3 py-2 px-3 fw-bold text-white btn-orange">Daftar Sekarang</a>
          </div>
        </div>
      </div>
    </div>
